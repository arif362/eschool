...
RSpec.describe School, type: :model do
  ...
  describe '#instance method password' do
    it 'should return password which brings hashed value from this method' do
      #verify
      expect(@school.password).to eq('123456')
  ...
  describe '#class method encrypt_password' do
    it 'should return encrypted password from Digest::SHA1.hexdigest(password + "wibble" + salt)' do
      expect(Digest::SHA1.hexdigest(@school.password + 'wibble' + @school.salt)).to eq(Digest::SHA1.hexdigest('123456' + 'wibble' + '123456'))
    end
  end
